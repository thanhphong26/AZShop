...
<link rel="stylesheet"
	href="<c:url value="/templates/web/css/infor/owl.carousel.min.css"/>">
<!-- href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css" -->
<link rel="stylesheet"
	href="<c:url value="/templates/web/css/infor/owl.theme.default.min.css"/>">
<!-- 	href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.green.min.css" -->
<link rel="stylesheet"
	href="<c:url value="/templates/web/css/infor/owl.theme.green.min.css"/>">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/templates/web/css/home.css"/>" />
<link
...
<script
	href="<c:url value="/templates/web/vendor/bootstrap/js/popper.min.js"/>"
	integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r"
	crossorigin="anonymous"></script>
<script
	href="<c:url value="/templates/web/vendor/bootstrap/js/bootstrap.min.js"/>"
...
<script
	src="<c:url value="/templates/web/vendor/jquery/jquery.min.js"/>"></script>
<script
	src="<c:url value="/templates/web/vendor/jquery/owl.carousel.min.js"/>"></script>
<script>
